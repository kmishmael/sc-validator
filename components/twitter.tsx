...
{/*
            { (cardType == 'summary') ? (
                ...
                <div className="text-center px-2">
                    <div className="w-full sm:w-4/5 md:w-2/5 mx-auto border flex flex-row rounded-md h-24 sm:h-32 overflow-hidden border-gray-400">
                        <div className="w-24 sm:w-32 h-full">
                            <img src={meta.twitter_image as string} alt="" className="h-full w-full object-cover" />    
                        </div>
            ...
            { meta.twitter_card == 'summary_large_app' ? (
                <div className="text-center my-8 px-2">
                    <div className="w-full sm:w-4/5 md:w-2/5 mx-auto border flex flex-col rounded-md overflow-hidden border-gray-400">
                        <div className="w-full h-64">
                            <img src={meta.twitter_image as string} alt="" className="h-full w-full object-cover" />    
                        </div>
            ...
            { meta ? (
                <div className="text-center px-2">
                    <div className="w-full sm:w-4/5 md:w-2/5 mx-auto border flex flex-row rounded-md h-24 sm:h-32 overflow-hidden border-gray-400 pr-1">
                        <div className="w-1/4 h-full flex justify-center bg-gray-100 border-r border-gray-400">
                            <img src='/twitter-no-image.svg' alt="" className="w-1/3 h-1/3 m-auto object-cover" />    
                        </div>
