   ...
   const renderThemeChanger = () => {
    ...
    return (
        ...
        <div className="w-full h-10 px-6 py-6 flex flex-row justify-center">
            ...
            <div className="flex flex-row gap-3 text-light-social font-normal text-lg h-fit items-center">

            <Link href={'/'} className="flex flex-row gap-3">
            <Image height={30} width={30} src={`/logo.svg`} alt="logo" aria-label="logo image" />
   
                <p className="hidden sm:block font-normal ">Social Validator</p>
            </Link>
            </div>
            <span className="uppercase absolute -right-16 bottom-1/2 text-sm border-deep-purple text-deep-purple px-2 rounded-full border-2" style={{}}>Beta</span>
